$(function () {
  ...
  QUnit.test('should not close a collapse when initialized with "show" options if already shown', function (assert) {
    assert.expect(0)
    var done = assert.async()
  ...
  QUnit.test('should open a collapse when initialized with "show" options if not already shown', function (assert) {
    assert.expect(1)
    var done = assert.async()
  ...
  QUnit.test('should not show a collapse when initialized with "hide" options if already hidden', function (assert) {
    assert.expect(0)
    var done = assert.async()
  ...
  QUnit.test('should hide a collapse when initialized with "hide" options if not already hidden', function (assert) {
    assert.expect(1)
    var done = assert.async()
