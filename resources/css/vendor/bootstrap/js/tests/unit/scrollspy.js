$(function () {
  ...
  QUnit.test('should correctly select middle navigation options when large offset is used', function (assert) {
    assert.expect(3)
    var done = assert.async()
  ...
  QUnit.test('should allow passed in options offset method: offset', function (assert) {
    assert.expect(4)
    ...
    var testOffsetMethod = function (type) {
      ...
      assert.ok(scrollspy._offsets[1] === $target.offset().top, 'offset method with ' + type + ' options')
      assert.ok(scrollspy._offsets[1] !== $target.position().top, 'position method with ' + type + ' options')
      $navbar.remove()
      $content.remove()
    }
  ...
  QUnit.test('should allow passed in options offset method: position', function (assert) {
    assert.expect(4)
