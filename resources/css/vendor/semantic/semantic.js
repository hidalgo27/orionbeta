      ...
      module = {
          ...
          value: function(value, text, $selected) {
            ...
            if(hasInput) {
              ...
              if( module.is.single() && module.has.selectInput() && module.can.extendSelect() ) {
                module.debug('Adding user options', value);
        ...
        add: {
          ...
          optionValue: function(value) {
            var
              escapedValue = module.escape.value(value),
              $option      = $input.find('options[value="' + module.escape.string(escapedValue) + '"]'),
            ...
            if( module.is.single() ) {
              ...
              $input.find('options.' + className.addition).remove();
            }
            $('<options/>')
              ...
              .appendTo($input)
            ;
            module.verbose('Adding user addition as an <options>', value);
            module.observe.select();
          },
        ...
        remove: {
          ...
          optionValue: function(value) {
            ...
            $option.remove();
            module.verbose('Removing user addition as an <options>', escapedValue);
            if(selectObserver) {
          ...
          value: function(removedValue, removedText, $removedItem) {
            ...
            ;
            if( module.has.selectInput() ) {
              module.verbose('Input is <select> removing selected options', removedValue);
