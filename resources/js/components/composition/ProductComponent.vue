<template>
    ...
    <section class="description">
        ...
        <badge-component :product="product"></badge-component>
        ...
        <p class="description__price" :style="{ color: price_color }">
            $ {{ new Intl.NumberFormat("es-PE").format(product.price) }}
        </p>
    ...
    setup(props, context){
        const productState = reactive({
            ...
            price_color: computed(()=>
                props.product.stock <= 1 ? "rgb(188 30 67)" : "rgb(188 30 67)"
            )
            // price_color : computed(()=>{
        ...
        const discountCodes = ref(["1234", "abcd"]);
