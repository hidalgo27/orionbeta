$(function () {
  ...
  QUnit.test('should wrap around from end to start when wrap options is true', function (assert) {
    assert.expect(3)
  ...
  QUnit.test('should wrap around from start to end when wrap options is true', function (assert) {
    assert.expect(1)
    var carouselHTML = '<div id="carousel-example-generic" class="carousel slide" data-wrap="true">' +
        '<ol class="carousel-indicators">' +
        '<li data-target="#carousel-example-generic" data-slide-to="0" class="active"/>' +
  ...
  QUnit.test('should not add touch event listeners when touch options set to false', function (assert) {
    assert.expect(1)
